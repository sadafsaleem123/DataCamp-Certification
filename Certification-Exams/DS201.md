We are given two tables student_df and age_df, that contains the names, locations and ages of students. Perform an inner join on table age_df to combine the tables based on Name column.
...
### 49. sadafsaleem5815@gmail.com
We use supervised classification algorithms when we want to:
find relationships
model features
create new clusters
map an input
