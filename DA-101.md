...
11. Four teams competed in a relay race. One team member ran as many laps around a track as they could and then passed the baton to the next in line. The number of laps were recorded for each team member. Which team had the least amount of variability in their results?

![124](https://user-images.githubusercontent.com/61821924/213879861-b2f46d42-d81e-4fea-81a2-446b578ddc4c.PNG)
...
12. A credit analyst would like to visualize the 25th, 50th, and 75th percentile credit scores for each credit product offered at the company. Which data visualization would be most appropriate to show this information?
+ Box
+ Heatmap
+ Scatter
+ Bar

13. Your city has set up a sensor in order to determine the speed of each vehicle that passes through your street. You have obtained the data from this sensor, which contains 13,937 observations recorded over the course of a month. Which type of data visualization should you use if you would like to quickly see the 25th, 50th, and 75th percentiles of the vehicle speeds?
+ Bar plot 
+ Box plot
+ Line plot
+ Histogram

14. Participants in a survey provided information about their parents' heights. The results are shown below.

![125](https://user-images.githubusercontent.com/61821924/213879953-af07b9c6-8b22-4448-9eff-4813a33616cf.PNG)
+ Not correlated
+ Negatively correlated
+ Positively correlated

15. A histogram of test scores is shown below. Mode of the score is?

![126](https://user-images.githubusercontent.com/61821924/213880024-4278a33c-3b43-43e5-a54d-fc526cbbbac6.PNG)
+ 2
+ 9
+ 10
+ 18

16. A correlation matrix of 8 variables is shown below.How would you describe the relationship between variables C and D?

![127](https://user-images.githubusercontent.com/61821924/213880148-45a3d67c-5602-42de-8739-ebcc48ff420b.PNG)

+ Both are highly negatively correlated
+ Both are highly positively correlated
+ Both are weakly positively correlated
+ Both are weakly negatively correlated

17. You have completed some market research into brand preferences of rice in your country. In each region, you asked hundreds of respondents to rate each brand of rice on a scale from 0 to 10. The average rating for each brand in each region is shown in the heatmap below.



18. You are a financial advisor preparing for a client review meeting. Your report tracks your client's account performance over the last year. Which visualization would be most appropriate for this data?
+ Scatter
+ Histogram
+ Line chart
+ Pie chart

19. According to the following Scatter plot, what could we say about the relationship between Number of absences and School performance?

![128](https://user-images.githubusercontent.com/61821924/213880261-36cd281f-2430-45bb-a780-9e74f4afe96c.PNG)
