...
import numpy as np
poisson_data = np.random._____ WCH (3, 10)
print(poisson_data)
...
- [ ] We reject the null hypothesis and there is a difference between the campaigns
...
- [ ] A meausre computed from a sample and a measure computed from a population
...
- [ ] A statistics refers to the sample while a parameter refers to the whole population
